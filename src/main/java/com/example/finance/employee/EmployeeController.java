...
public class EmployeeController {
    ...
    @GetMapping
    public PageResponse<EmployeeResponse> list(@PathVariable UUID companyId,
    ...
    @GetMapping("/{id}")
    public EmployeeResponse get(@PathVariable UUID companyId, @PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public EmployeeResponse update(@PathVariable UUID companyId, @PathVariable UUID id, @Valid @RequestBody EmployeeRequest request) {
