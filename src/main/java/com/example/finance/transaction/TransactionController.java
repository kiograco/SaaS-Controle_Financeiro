...
@Tag(name = "Lancamentos Financeiros")
public class TransactionController {

    private final TransactionService service;

    @GetMapping
    public PageResponse<TransactionResponse> list(@PathVariable UUID companyId,
    ...
    @GetMapping("/{id}")
    public TransactionResponse get(@PathVariable UUID companyId, @PathVariable UUID id) {
        return service.get(companyId, id);
    }

    @PostMapping
    public TransactionResponse create(@PathVariable UUID companyId, @Valid @RequestBody TransactionRequest request) {
        return service.create(companyId, request);
    }

    @PutMapping("/{id}")
    public TransactionResponse update(@PathVariable UUID companyId, @PathVariable UUID id, @Valid @RequestBody TransactionRequest request) {
